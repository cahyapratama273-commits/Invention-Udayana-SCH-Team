// Beranda.js — baca kondisi mental dari localStorage, render sapaan + artikel
...
(function () {
  ...
  function renderSapaan() {
    ...
    // ambil judul/pesan personal hasil quiz kalau ada, kalau nggak pakai teks default per kondisi
  ...
  // Dipanggil langsung, BUKAN nunggu event.
  // Script ini ada di dalam #app-content, jadi otomatis ke-eksekusi ulang
  // dari awal setiap kali halaman ini dibuka -- baik pas full reload (F5)
  // maupun pas navigasi AJAX lewat Nav.js. DOM sudah pasti siap karena
  // tag <script> ini posisinya SETELAH elemen yang dibutuhkan (#sapaan-card,
  // #artikel-grid) di dalam HTML yang sama.
